...
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('97807739518', 3), -- Orgulho e Preconceito - Romance
                                                                          ('97807739518', 11), -- Orgulho e Preconceito - Drama
                                                                          ('97807739686', 3), -- Emma - Romance
                                                                          ('97807739686', 11), -- Emma - Drama
                                                                          ('97807739662', 3), -- Razão e Sensibilidade - Romance
                                                                          ('97807739662', 11); -- Razão e Sensibilidade - Drama
...
-- Homer
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978070268867', 2), -- Odisseia - Fantasia
                                                                          ('978070268867', 6), -- Odisseia - Aventura
                                                                          ('978070268867', 7), -- Odisseia - História
                                                                          ('978070268867', 10), -- Odisseia - Poesia
                                                                          ('978070275360', 2), -- Ilíada - Fantasia
                                                                          ('978070275360', 6), -- Ilíada - Aventura
                                                                          ('978070275360', 7), -- Ilíada - História
                                                                          ('978070275360', 10); -- Ilíada - Poesia

-- Fyodor Dostoevsky
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('97807305874', 11), -- Crime e Castigo - Drama
                                                                          ('97807305874', 18), -- Crime e Castigo - Filosofia
                                                                          ('97807305874', 19), -- Crime e Castigo - Psicologia
...
-- Ray Bradbury
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978751673319', 1), -- Fahrenheit 451 - Ficção Científica
                                                                          ('978751673319', 11), -- Fahrenheit 451 - Drama
                                                                          ('978751673319', 18), -- Fahrenheit 451 - Filosofia
                                                                          ('978751678192', 1), -- Crônicas Marcianas - Ficção Científica
                                                                          ('978751678192', 2); -- Crônicas Marcianas - Fantasia
...
-- Toni Morrison
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978700033416', 11), -- Amada - Drama
                                                                          ('978700033416', 7), -- Amada - História
                                                                          ('978700033416', 5), -- Amada - Terror
                                                                          ('978700033423', 11), -- O Olho Mais Azul - Drama
                                                                          ('978700033423', 20); -- O Olho Mais Azul - Sociologia

-- William Golding
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978039950787', 6), -- O Senhor das Moscas - Aventura
                                                                          ('978039950787', 11), -- O Senhor das Moscas - Drama
                                                                          ('978039950787', 18), -- O Senhor das Moscas - Filosofia
...
-- Dante Alighieri
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978072437223', 10), -- Inferno - Poesia
                                                                          ('978072437223', 2), -- Inferno - Fantasia
                                                                          ('978072437223', 21), -- Inferno - Religião
                                                                          ('978072437223', 18), -- Inferno - Filosofia
                                                                          ('978072437247', 10), -- Purgatório - Poesia
                                                                          ('978072437247', 2), -- Purgatório - Fantasia
                                                                          ('978072437247', 21), -- Purgatório - Religião
                                                                          ('978072437247', 18); -- Purgatório - Filosofia

-- Herman Melville
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978073105954', 6), -- Moby Dick - Aventura
                                                                          ('978073105954', 11), -- Moby Dick - Drama
                                                                          ('978073105954', 18), -- Moby Dick - Filosofia
...
-- Charlotte Brontë
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('9780774176', 3), -- Jane Eyre - Romance
                                                                          ('9780774176', 11), -- Jane Eyre - Drama
                                                                          ('9780199536658', 3), -- Villette - Romance
                                                                          ('9780199536658', 11); -- Villette - Drama

-- Mark Twain
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978073107323', 6), -- As Aventuras de Huckleberry Finn - Aventura
                                                                          ('978073107323', 7), -- As Aventuras de Huckleberry Finn - História
                                                                          ('978073107323', 12), -- As Aventuras de Huckleberry Finn - Humor
                                                                          ('978073039563', 6), -- As Aventuras de Tom Sawyer - Aventura
                                                                          ('978073039563', 12), -- As Aventuras de Tom Sawyer - Humor
                                                                          ('978073039563', 13); -- As Aventuras de Tom Sawyer - Infantil

-- Johann Wolfgang von Goethe
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978073106951', 3), -- Os Sofrimentos do Jovem Werther - Romance
                                                                          ('978073106951', 11), -- Os Sofrimentos do Jovem Werther - Drama
                                                                          ('978073106951', 10), -- Os Sofrimentos do Jovem Werther - Poesia
                                                                          ('978070449013', 11), -- Fausto - Drama
                                                                          ('978070449013', 2), -- Fausto - Fantasia
                                                                          ('978070449013', 10), -- Fausto - Poesia
                                                                          ('978070449013', 18); -- Fausto - Filosofia

-- Leo Tolstoy
INSERT INTO livro_pertence_categoria (fk_livro_isbn, fk_categoria_id) VALUES
                                                                          ('978073035008', 7), -- Guerra e Paz - História
                                                                          ('978073035008', 11), -- Guerra e Paz - Drama
                                                                          ('978073035008', 3), -- Guerra e Paz - Romance
                                                                          ('978073035002', 3), -- Anna Karenina - Romance
                                                                          ('978073035002', 11), -- Anna Karenina - Drama
                                                                          ('978073035002', 18); -- Anna Karenina - Filosofia