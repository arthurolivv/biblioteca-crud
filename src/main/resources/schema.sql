    ...
    create table usuario_emprestimo_exemplar (
        ...
        data_devolucao_prevista timestamp(6),
        data_emprestimo timestamp(6),
        fk_exemplar_numero_exemplar bigint,
        id bigint generated by default as identity,
        fk_livro_isbn varchar(255),
    ...
    create table usuario_reserva_livro (
        ...
        id bigint generated by default as identity,
        fk_livro_isbn varchar(255),
        fk_usuario_oplid varchar(255),
        status varchar(255) check (status in ('PENDENTE','DISPONIVEL','CANCELADA','CONCLUIDA')),
        primary key (id)
    );
